	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav ms-auto">
				...
				<li class="nav-item"><a href="index.jsp#" data-bs-toggle="modal"
					data-bs-target="#exampleModal" class="nav-link">Contact </a></li>
			</ul>
			...
			<% 
				...
				{
					%>
					<a href="controller/login.jsp" class="btn btn-brand ms-lg-3">Logout</a>
					<%
				}
				else
				{
					%>
					<a href="view/login.jsp" class="btn btn-brand ms-lg-3">Login</a>
					<%
				}
			%>					
		</div>
